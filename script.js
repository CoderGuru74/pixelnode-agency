 ...
 * Includes: 3D Torus, Mobile Menu, Swiper, and EmailJS
 */
...
window.onload = function() {
    ...
    if (menuBtn && mobileMenu) {
        menuBtn.addEventListener('click', () => {
            ...
            mobileMenu.classList.add('flex'); // Ensure it uses flexbox when shown
        ...
        // Close menu if any link inside is clicked
    ...
    // --- 4. CONTACT PAGE: EMAILJS INTEGRATION ---
